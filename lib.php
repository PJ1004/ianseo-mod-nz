...
function CreateStandardClasses($TourId, $SubRule) {
	...
	switch($SubRule) {
		case '1': // All NZ Classes
			...
			CreateClass($TourId, $i++, 14, 15, 0, 'U16M', 'U16M,U18M,U21M', 'Under 16 Boys');
			CreateClass($TourId, $i++, 14, 15, 1, 'U16W', 'U16W,U18W,U21W', 'Under 16 Girls');
			CreateClass($TourId, $i++, 11, 13, 0, 'U14M', 'U14M,U16M', 'Under 14 Boys');
			CreateClass($TourId, $i++, 11, 13, 1, 'U14W', 'U14W,U16W', 'Under 14 Girls');
			CreateClass($TourId, $i++,  1, 10, 0, 'U11M', 'U11M,U14M,U16M', 'Under 11 Boys');
			CreateClass($TourId, $i++,  1, 10, 1, 'U11W', 'U11W,U14W,U16W', 'Under 11 Girls');
	...
	*/
	...
	switch($SubRule) {
		case '1':
			...
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetIr, 5, 3, 1, 5, 3, 1, 'RU16M', 'Recurve Under 16 Boys', 1, 240, 240, 0, 0, '', '', $TargetSizeR, $DistanceI);
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetIr, 5, 3, 1, 5, 3, 1, 'RU16W', 'Recurve Under 16 Girls', 1, 240, 240, 0, 0, '', '', $TargetSizeR, $DistanceI);
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetYr, 5, 3, 1, 5, 3, 1, 'RU14M', 'Recurve Under 14 Boys', 1, 240, 240, 0, 0, '', '', $TargetSizeR, $DistanceY);
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetYr, 5, 3, 1, 5, 3, 1, 'RU14W', 'Recurve Under 14 Girls', 1, 240, 240, 0, 0, '', '', $TargetSizeR, $DistanceY);
			...
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetIc, 5, 3, 1, 5, 3, 1, 'CU16M', 'Compound Under 16 Boys', 0, 240, 240, 0, 0, '', '', $TargetSizeC, $DistanceI);
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetIc, 5, 3, 1, 5, 3, 1, 'CU16W', 'Compound Under 16 Girls', 0, 240, 240, 0, 0, '', '', $TargetSizeC, $DistanceI);
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetYc, 5, 3, 1, 5, 3, 1, 'CU14M', 'Compound Under 14 Boys', 0, 240, 240, 0, 0, '', '', $TargetSizeC, $DistanceY);
			CreateEvent($TourId, $i++, 0, 0, $FirstPhase, $TargetYc, 5, 3, 1, 5, 3, 1, 'CU14W', 'Compound Under 14 Girls', 0, 240, 240, 0, 0, '', '', $TargetSizeC, $DistanceY);
			if($allowBB) {
